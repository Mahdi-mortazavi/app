    ...
    return Column(
      children: [
        GestureDetector(
          ...
          child: Semantics(
            label: "ویرایش کار: ${widget.task.title}",
            hint: widget.task.subtasks.isNotEmpty
                ? "برای نمایش زیرمجموعه‌ها نگه دارید"
                : null,
            button: true,
            child: Container(
              ...
              child: Row(
                children: [
                  Semantics(
                    ...
                    value: widget.isDone ? "انجام شده" : "انجام نشده",
              ...
              ? Container(
                  ...
                  child: Column(
                    children: widget.task.subtasks
                        .map(
                          (s) => Semantics(
                            label: "تغییر وضعیت زیرمجموعه: ${s.title}",
                            value: s.isCompleted ? "انجام شده" : "انجام نشده",
                            child: ListTile(
                              dense: true,
                              leading: Icon(
                                s.isCompleted
