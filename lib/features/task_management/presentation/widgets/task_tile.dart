            ...
            GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  color: widget.isDone ? AppTheme.green : Colors.transparent,
                  border: Border.all(
                    color:
                        widget.isDone ? AppTheme.green : Colors.grey.shade300,
                    width: 2,
                  ),
                ),
                child: widget.isDone
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color:
                          widget.isDone ? AppTheme.textSub : AppTheme.textMain,
                    ),
                  ),
                  if (!widget.isDone)
                    Padding(
