...
// in app/test/features/task_management/presentation/bloc/tasks_bloc_test.dart.
...
import 'package:app/features/notifications/domain/services/vibration_service.dart'
    as _i6;
import 'package:app/features/task_management/domain/entities/task.dart' as _i4;
...
class MockNotificationService extends _i1.Mock
  ...
  _i3.Future<void> init(
          {required dynamic Function(int)? onNotificationTapped}) =>
      (super.noSuchMethod(
        Invocation.method(
          #init,
          [],
  ...
  @override
  _i3.Future<void> scheduleNotification(_i4.Task? task) => (super.noSuchMethod(
        Invocation.method(
...
/// A class which mocks [VibrationService].
///
/// See the documentation for Mockito's code generation for more information.
class MockVibrationService extends _i1.Mock implements _i6.VibrationService {
  MockVibrationService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<void> vibrateSuccess() => (super.noSuchMethod(
        Invocation.method(
          #vibrateSuccess,
          [],
        ),
  ...
  @override
  _i3.Future<void> vibrateLight() => (super.noSuchMethod(
        Invocation.method(
          #vibrateLight,
          [],
        ),
